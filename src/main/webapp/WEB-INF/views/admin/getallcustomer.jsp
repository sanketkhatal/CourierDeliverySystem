...
<body>
    ...
    <div class="col-lg-9 m-auto d-block"><br>
        <div class="card-header bg-info">
            <h1 class="text-white text-center">All Customers</h1>
        </div>
        ...
        <div id="items" class="my-4">
            ...
            <thead>
                ...
                <c:forEach var="c" items="${requestScope.all_customers}">
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-danger" href="/admin/deletecustomer/${c.cid}" role="button">Delete</a></td>
