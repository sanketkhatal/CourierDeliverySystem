    ...
    <!-- See your profile -->
       ...
       <div class="col-lg-9 m-auto d-block"><br>
        <div class="card-header bg-info">
            <h1 class="text-white text-center">My Orders</h1>
        </div>
        ...
        <div id="items" class="my-4">
            ...
            <thead>
    			<tr>
      				...
      				<th scope="col">Sender's Contact No</th>
      				<th scope="col">Receiver's Contact No</th>
                ...
                <c:forEach var="o" items="${requestScope.pending_orders}">
                    ...
                    <tr>
                        ...
                        <td><a href="/delivery/updateorderstatus?orderId=${o.orderId}" class="btn btn-primary" >delivered</a>
                        </td>
                    </tr>
