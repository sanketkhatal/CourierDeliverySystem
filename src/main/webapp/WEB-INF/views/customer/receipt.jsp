   ...
   <!-- RECEIPT Generation  -->
    ...
    <div class="col-lg-8 m-auto d-block"><br>
        <div class="card-header bg-info">
            <h1 class="text-white text-center">Receipt</h1>
        </div>
            ...
            <table class="table">
                <tbody id="tableBody">
                    <tr>
                        ...
                        <td>${requestScope.order_details.orderId}</td>
                    </tr>

                    <tr>
                        <th scope="row">Delivery Date:</th>
                        <td>${requestScope.order_details.deliveryDate}</td>
                    </tr>

                    <tr>
                        <th scope="row">Pickup Address:</th>
                        <td>${requestScope.order_details.pickAddress}</td>
                    </tr>

                    <tr>
                        <th scope="row">Drop Address:</th>
                        <td>${requestScope.order_details.dropAddress}</td>
                    </tr>
                    
                    
                    <tr>
                        <th scope="row">Sender's Contact No:</th>
                        <td>${requestScope.order_details.sendermobile}</td>
                    </tr>
                    
                    
                    <tr>
                        <th scope="row">Receiver Contact No:</th>
                        <td>${requestScope.order_details.receivermobile}</td>
                    </tr>
                    
                    
                    <tr>
                        <th scope="row">Area:</th>
                        <td>${requestScope.order_details.area}</td>
                    </tr>
                    
                     <tr>
                        <th scope="row">Total Amount:</th>
                        <td>${requestScope.order_details.totalBill}</td>
                    </tr>
